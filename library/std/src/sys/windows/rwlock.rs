...
use crate::sys::elision::{have_elision, AtomicElisionExt};
use crate::sys::mutex::{TOKEN_HANDOFF, TOKEN_NORMAL};
use core::{
    cell::Cell,
    sync::atomic::{AtomicUsize, Ordering},
};
use crate::time::Instant;
use crate::sys::parking_lot_core::{
...
impl RWLock {
    pub const fn new() -> RWLock {
        RWLock { state: AtomicUsize::new(0) }
    }
